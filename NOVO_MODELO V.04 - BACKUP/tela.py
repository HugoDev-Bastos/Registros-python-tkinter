...
class Funcs():
    ...
    def consultar(self):
        ...
        if self.pesquisar_entry.get()  == "":
            messagebox.showinfo(title="Erro de operação!" ,message="Digite algo no 'Campo de Consulta' para pesquisar!")
    ...
    def deletar(self): ### Deletar Cliente
        ...
        if self.entry_cod.get()  == "":
            messagebox.showinfo(title="Erro de operação!" ,message="Digite o número 'Cod' do Registro que deseja Excluir!")
        else: 
...
class Aplication(Funcs):
    ...
    def tela(self):
        ...
        self.window.maxsize(width=1000, height=435)  
    ...
    def FrameConsultarRegistros(self):
        ...
        btn_pesquisar = Button(self.labelFrame_Novo, text="Pesquisar", bd=3, bg="#107db2", fg="#FFF", activebackground="#108ecb", activeforeground="#FFF", font=('verdana', 10, 'bold'), command=self.consultar)
        btn_pesquisar.place(relx=0.72, rely=0.02, relwidth=0.12)
        
        btn_todos = Button(self.labelFrame_Novo, text="Todos", bd=3, bg="#107db2", fg="#FFF", activebackground="#108ecb", activeforeground="#FFF", font=('verdana', 10, 'bold'), command=self.consultar_tudo)
    ...
    def FrameCadastradosRegistros(self):
        ...
        self.registrados.bind("<Double-1>", self.OnDoubleClick)
         ...
         # Botões Apagar
        self.bt_apagar = Button(self.frameCadastrados, text="Excluir", bd=3, bg="#107db2", fg="#FFF", activebackground="#108ecb", activeforeground="#FFF", font=('verdana', 9, 'bold'), command=self.deletar)
